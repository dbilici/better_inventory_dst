...
This file contains ready-to-paste copy and the release checklist for `v0.8.6`.
...
Version 0.8.6 has passed automated sorting regression tests. The `v0.5.0`
...
- [x] `modinfo.lua` reports `0.8.6` and API version 10.
...
- [x] Update version references from `0.8.5` to `0.8.6`.
- [x] Add v0.8.6 change notes.
- [ ] Upload as Friends Only.
- [ ] Smoke test the subscribed Workshop copy.
- [ ] Confirm no `[Pack & Sort][WARN]` messages or Lua errors.
- [ ] Tag `v0.8.6` after the uploaded copy is verified.
